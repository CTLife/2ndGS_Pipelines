...
my $HELP = '
        ...
        Usage:
               perl  WG-ssDNA_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time perl  WG-ssDNA_1.pl    -in 1_rawFASTQ   > WG-ssDNA_1.runLog.txt  2>&1  & 
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  WG-ssDNA_1.pl  -help' \n";
    exit 0;
}
