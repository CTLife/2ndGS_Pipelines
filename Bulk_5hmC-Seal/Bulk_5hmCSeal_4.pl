...
my $HELP = '
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        Step 4: Only the mapped reads with MAPQ>20 are retained. And reads on other chromosomes are removed.
        ...
        Usage:
               perl  Bulk_5hmCSeal_4.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]  
        For instance:
               nohup time  perl Bulk_5hmCSeal_4.pl   -genome hg38   -in 3_rawBAM/1_BWA   -out 4_finalBAM/1_BWA     > Bulk_5hmCSeal_4.runLog.1_BWA.txt  2>&1    &  
...
## Version Infromation
my $version = "    The 4th Step, version 1.0,  2022-09-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  Bulk_5hmCSeal_4.pl  -help' \n";
    exit 0;
}
...
##  temp=Batch4_Ctrl.CBF10_S10
## samtools  view   -h    --threads 16   -f 0x2    -o  $temp.bam    1_BWA/$temp.bam  
