...
my $output_g = '';  ## such as "9-BED/1_Trim_BWAmem"
...
my $HELP = '
        ...
        Usage:
               perl  starCISDA8.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  starCISDA8.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem   -out 9-BED/1_Trim_BWAmem    > starCISDA8.runLog
...
## Version Infromation
my $version = "    The Eighth Step of starCISDA (small-scale TELP-assisted rapid ChIP–seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
$output_g = '9-BED/1_Trim_BWAmem';        ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  starCISDA8.pl  -help' \n";
    exit 0;
}
