...
my $HELP = '
        ...
        Usage:
               perl  starCISDA11C.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  starCISDA11C.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem/callPeaks   -out 12C-GEM/1_Trim_BWAmem    > starCISDA11C.runLog
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  starCISDA11C.pl  -help' \n";
    exit 0;
}
