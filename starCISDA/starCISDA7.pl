...
my $HELP = '
        ...
        Usage:
               perl  starCISDA7.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  starCISDA7.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem   -out 8-BAMPE/1_Trim_BWAmem    > starCISDA7.runLog
...
## Version Infromation
my $version = "    The Seventh Step of starCISDA (small-scale TELP-assisted rapid ChIP–seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  starCISDA7.pl  -help' \n";
    exit 0;
}
