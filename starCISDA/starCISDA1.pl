...
my $HELP = '
        ...
        Usage:
               perl  starCISDA1.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  starCISDA1.pl   -genome hg38   -in 1-rawReads   -out 2-mergedFASTQ    > starCISDA1.runLog  
...
## Version Infromation
my $version = "    The First Step of starCISDA (small-scale TELP-assisted rapid ChIP–seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  starCISDA1.pl  -help' \n";
    exit 0;
}
