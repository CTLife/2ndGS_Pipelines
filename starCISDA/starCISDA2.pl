...
my $HELP = '
        ...
        Usage:
               perl  starCISDA2.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  starCISDA2.pl   -genome hg38   -in 2-mergedFASTQ   -out 3-rmDupFASTQ    > starCISDA2.runLog  
...
## Version Infromation
my $version = "    The Second Step of starCISDA (small-scale TELP-assisted rapid ChIP–seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  starCISDA2.pl  -help' \n";
    exit 0;
}
