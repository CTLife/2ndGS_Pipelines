...
my $HELP = '
        ...
        Usage:
               perl  starCISDA11B.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  starCISDA11B.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem/callPeaks   -out 12B-Q/1_Trim_BWAmem    > starCISDA11B.runLog
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  starCISDA11B.pl  -help' \n";
    exit 0;
}
