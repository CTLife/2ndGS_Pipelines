...
my $HELP = '
        ...
        Usage:
               perl MeRIP_3.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               nohup  time   perl MeRIP_3.pl   -in 2_removedAdapters   -out 3_removedDups    > MeRIP_3.runLog.txt  2>&1     &      
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl MeRIP_3.pl  -help' \n";
    exit 0;
}
