...
my $HELP = '
        ...
        Usage:
               perl  MeRIP_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time  perl  MeRIP_1.pl    -in 1_rawFASTQ   > MeRIP_1.runLog.txt  2>&1  & 
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  MeRIP_1.pl  -help' \n";
    exit 0;
}
