...
my $HELP = '
        ...
        Usage:
               perl  MeRIP_4.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]  [-mis mismatch] 
        For instance:
               nohup time  perl  MeRIP_4.pl   -genome hg38   -in 3_removedDups   -out 4_rawBAM  -mis 0.05    > MeRIP_4.runLog  2>&1  &
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  MeRIP_4.pl  -help' \n";
    exit 0;
}
