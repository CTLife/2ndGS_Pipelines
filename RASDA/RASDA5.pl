...
my $output_g = '';  ## such as "6-BAMPE/3A_STAR"
...
my $HELP = '
        ...
        For instance:
               perl  RASDA5.pl   -genome hg38   -in 5-finalBAM/3A_STAR   -out 6-BAMPE/3A_STAR    > RASDA5.runLog
...
## Version Infromation
my $version = "    The 5th Step of RASDA (RNA-Seq Data Analyzer), version 0.9.4,  2018-02-01.";
...
$output_g = '6-BAMPE/3A_STAR';      ## This is only an initialization value or suggesting value, not default value.
