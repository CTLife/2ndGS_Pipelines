...
my $output_g = '';  ## such as "10-BigWig/3A_STAR"
...
my $HELP = '
        ...
        Usage:
               perl  RASDA9.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  RASDA9.pl   -genome hg38   -in 7-finalBAM/3A_STAR   -out 10-BigWig/3A_STAR    > RASDA9.runLog
...
## Version Infromation
my $version = "    The Ninth Step of RASDA (RNA-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
$output_g = '10-BigWig/3A_STAR';    ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  RASDA9.pl  -help' \n";
    exit 0;
}
