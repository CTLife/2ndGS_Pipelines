...
my $output_g = '';  ## such as "8-BAMPE/3A_STAR"
...
my $HELP = '
        ...
        For instance:
               perl  RASDA7.pl   -genome hg38   -in 7-finalBAM/3A_STAR   -out 8-BAMPE/3A_STAR    > RASDA7.runLog
...
## Version Infromation
my $version = "    The Seventh Step of RASDA (RNA-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
$output_g = '8-BAMPE/3A_STAR';      ## This is only an initialization value or suggesting value, not default value.
