...
my $HELP = '
        ...
        Usage:
               perl  RASDA1.pl    [-version]    [-help]     [-in inputDir]    [-out outDir]
        For instance:
               perl  RASDA1.pl    -in 1-rawFiles   -out 2-rawFASTQ    > RASDA1.runLog  
...
## Version Infromation
my $version = "    The First Step of RASDA (RNA-Seq Data Analyzer), version 0.9.4,  2018-02-01.";
