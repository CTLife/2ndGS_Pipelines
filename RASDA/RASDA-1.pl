...
my $HELP_g = '
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        Welcome to use RASDA (RNA-Seq Data Analyzer), version 0.51, 2016-01-01.    
        ...
        For instance: 
                     ...
                     perl  RASDA-1.pl    --input 1-rawReads     --output 2-FASTQ    >> 1-runLog.txt  2>&1
...
########## Version Infromation ##########
my $version_g = "    The First Step of RASDA (RNA-Seq Data Analyzer) , version 0.51, 2016-01-01.";
...
system("fastq-dump  -h           >> $output_g/version_softwares.txt   2>&1");
