...
my $HELP = '
        ...
        For instance:
               perl  RASDA3.pl   -genome hg38   -in 3-rmDupFASTQ   -out 4-finalFASTQ    > RASDA3.runLog  
...
## Version Infromation
my $version = "    The Third Step of RASDA (RNA-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
