...
my $HELP = '
        ...
        Usage:
               perl cfRNA_5.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]   
        For instance:
               nohup  time  perl cfRNA_5.pl   -genome hg38   -in 4_rawBAM/3_STAR   -out 5_finalBAM/3_STAR       > cfRNA_5.runLog 2>&1  &  
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  cfRNA_5.pl  -help' \n";
    exit 0;
}
