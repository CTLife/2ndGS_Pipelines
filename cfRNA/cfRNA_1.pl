...
my $HELP = '
        ...
        Step 1: This script will directly assess the quality of raw reads to identify possible experimental and sequencing errors or biases 
                ...
                For single-end sequencing, filenames of FASTQ files must always end with:
                 ".fastq.gz".  
        ...
        Usage:
               perl  cfRNA_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time  perl  cfRNA_1.pl    -in 1_rawFASTQ   > cfRNA_1.runLog.txt  2>&1  & 
...
## Version Infromation
my $version = "    The 1st Step, version 1.5,  2023-01-30.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  cfRNA_1.pl  -help' \n";
    exit 0;
}
