## example:  Rscript   mC-reads.R   2_P9D-H2KN3CCXY_Rep1   2_P9D-H2KN3CCXY_Rep1.bismark.cov    readsDis_mCpG   
...
FigureTemp1 <- ggplot( data = list_fre, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
               ...
               geom_point(alpha=0.5, size=2 ) +  xlab("Coverage (number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("1a_Frequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_fre, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
               ...
               geom_point(alpha=0.5, size=2 ) +  xlab("Coverage (number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("1b_Frequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_fre, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
               ...
               geom_point(alpha=0.5, size=2 ) +  xlab("Coverage (number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("1c_Frequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_fre, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
  ...
  geom_point(alpha=0.5, size=2) +  xlab("Coverage (number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("2a_Frequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_fre, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
  ...
  geom_point(alpha=0.5, size=2) +  xlab("Coverage (number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("2b_Frequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_cum, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
  scale_colour_manual( values= c("red", "blue", "yellow4" ), breaks=c("methylated", "unmethylated", "total") ) +
  scale_x_continuous(  breaks=c(0,  25, 50, 75, 100 ), labels=c("0",   "25", "50", "75", "100")  ) +  geom_line(size=1) + xlim(0,101) +
  geom_point(alpha=0.5, size=2 ) +  xlab("Coverage (>= number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Cumulative frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("3_CumulativeFrequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_cum, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
  ...
  scale_x_continuous(  breaks=c(0,  5, 10, 15, 20 ), labels=c("0",   "5", "10", "15", "20"   )   ) + geom_line(size=1) + xlim(0,20) + 
  geom_point(alpha=0.5, size=2) +  xlab("Coverage (>= number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Cumulative frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("4_CumulativeFrequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_cum, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
  ...
  geom_point(alpha=0.5, size=2) +  xlab("Coverage (>= number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Cumulative frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("5_CumulativeFrequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
FigureTemp1 <- ggplot( data = list_cum, aes(x = xAxis, y = yAxis,   colour=sampleType ) ) +  
  ...
  geom_point(alpha=0.5, size=2 ) +  xlab("Coverage (>= number of reads)") +   ylab("Number of CpG sits (10^6)") +   ggtitle("Cumulative frequency distribution of reads on CpG sits (total>=1)") +  MyTheme_1()
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=outPath2, fileName1=paste("6_CumulativeFrequency",  inputDir,   sep="_")        ,  height1=5,  width1=7)
...
MyHistogram_1A(vector2=methylated/all_un_me,  path2=outPath2,   
               fileName2=paste("7_MethylatedRatio_distribtion",  inputDir,   sep="_"),  
...
MyHistogram_1A(vector2=methylated/all_un_me,  path2=outPath2,   
               fileName2=paste("8_MethylatedRatio_distribtion",  inputDir,   sep="_"),  
               title2="Distributions of Methylated ratio of Cs",  xLab2="Methylated Ratio", 
