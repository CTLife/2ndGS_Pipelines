...
my $HELP_g = '
        ...
        Usage:  
               perl  CISDA8-BAM.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]   
        For instance: 
               perl  CISDA8-BAM.pl    -in 6-FinalBAM/1_BWA     -out 9-BigWig-BAM/1_BWA   >> CISDA8-BAM.runLog  2>&1
...
my $output_g  = '9-BigWig-BAM/1_BWA';     ## This is only an initialization  value or suggesting value, not default value.
...
if($boole_g == 1) {
    ...
    print   '    Please see help message by using "perl  CISDA8-BAM.pl  -help". ';
    print "\n\n";
    exit 0;
}
