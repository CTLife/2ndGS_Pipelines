...
my $HELP = '
        ...
        Usage:
               perl  CISDA8.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  CISDA8.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem   -out 9-BED/1_Trim_BWAmem    > CISDA8.runLog
...
## Version Infromation
my $version = "    The Eighth Step of CISDA (ChIP-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  CISDA8.pl  -help' \n";
    exit 0;
}
