...
my $output_g = '';  ## such as "7-BigWig/1_BWAmem"
...
my $HELP = '
        ...
        Usage:
               perl  CISDA6.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  CISDA6.pl   -genome hg38   -in 5-finalBAM/1_BWAmem   -out 7-BigWig/1_BWAmem    > CISDA6.runLog
...
## Version Infromation
my $version = "    The Ninth Step of CISDA (ChIP-Seq Data Analyzer), version 0.9.4,  2018-02-01.";
...
$output_g = '7-BigWig/1_BWAmem';     ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  CISDA6.pl  -help' \n";
    exit 0;
}
