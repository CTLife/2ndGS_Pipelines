...
my $HELP = '
        ...
        Usage:
               perl  CISDA1.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  CISDA1.pl   -genome hg38   -in 1-rawReads   -out 2-mergedFASTQ    > CISDA1.runLog  
...
## Version Infromation
my $version = "    The First Step of CISDA (ChIP-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
