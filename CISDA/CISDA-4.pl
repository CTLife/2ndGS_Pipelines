...
my $HELP_g = '
        ...
        Step 4: Only the mapped reads with MAPQ>20 are retained and reads on chr_random, chrUn and chrM, all of them are removed.
        ...
        Usage:  
               perl  CISDA4.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]  
        For instance: 
               perl  CISDA4.pl    -in 4-Mapping/4_Subread     -out 5-MAPQ20/4_Subread      >> CISDA4.runLog  2>&1
...
## Version Information
my $version_g = "  The Fourth Step of CISDA (ChIP-Seq Data Analyzer), version 0.7.2, 2016-04-17.";
...
my $input_g  = '4-Mapping/4_Subread';      ## This is only an initialization  value or suggesting value, not default value.
my $output_g = '5-MAPQ20/4_Subread';       ## This is only an initialization  value or suggesting value, not default value.
...
if($boole_g == 1) {
    ...
    say   "\tPlease see help message by using 'perl  CISDA4.pl  -h' \n";
    exit 0;
}
