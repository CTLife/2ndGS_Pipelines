...
my $HELP = '
        ...
        For instance:
               perl  CISDA3.pl   -genome hg38   -in 3-rmDupFASTQ   -out 4-finalFASTQ    > CISDA3.runLog  
...
## Version Infromation
my $version = "    The Third Step of CISDA (ChIP-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
