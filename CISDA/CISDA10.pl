...
my $HELP = '
        ...
        Usage:
               perl  CISDA10.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  CISDA10.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem   -out 11-DeepTools/1_Trim_BWAmem    > CISDA10.runLog
...
## Version Infromation
my $version = "    The Tenth Step of CISDA (ChIP-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  CISDA10.pl  -help' \n";
    exit 0;
}
