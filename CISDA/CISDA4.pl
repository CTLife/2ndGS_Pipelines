...
my $HELP_g = '
        ...
        For instance: 
               perl  CISDA4.pl    -in 4-Mapping/1_BWA     -out 5-MAPQ30/1_BWA      >> CISDA4.runLog  2>&1
...
## Version Information
my $version_g = "  The Fourth Step of CISDA (ChIP-Seq Data Analyzer), version 0.7.3, 2016-06-01.";
...
my $input_g  = '4-Mapping/1_BWA';      ## This is only an initialization  value or suggesting value, not default value.
my $output_g = '5-MAPQ30/1_BWA';       ## This is only an initialization  value or suggesting value, not default value.
...
if($boole_g == 1) {
    ...
    say   "\tPlease see help message by using 'perl  CISDA4.pl  -help' \n";
    exit 0;
}
