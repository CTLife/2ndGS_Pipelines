...
my $HELP_g = '
        ...
        Usage:  
               perl  CISDA6.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]   
        For instance: 
               perl  CISDA6.pl    -in 6-FinalBAM/1_BWA     -out 7-SortName/1_BWA   >> CISDA6.runLog  2>&1
...
## Version Information
my $version_g = "  The Sixth Step of CISDA (ChIP-Seq Data Analyzer), version 0.7.3, 2016-06-01.";
...
my $output_g  = '7-SortName/1_BWA';      ## This is only an initialization  value or suggesting value, not default value.
...
if($boole_g == 1) {
    ...
    print   '    Please see help message by using "perl  CISDA6.pl  -help". ';
    print "\n\n";
    exit 0;
}
