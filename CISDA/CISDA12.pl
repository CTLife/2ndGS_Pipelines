...
my $HELP = '
        ...
        Usage:
               perl  CISDA12.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  CISDA12.pl   -genome hg38   -in 12A-MACS2/1_Trim_BWAmem/1-Peaks/run10   -out 13A-IDR/1_Trim_BWAmem/1-Peaks/run10    > CISDA12.runLog
...
## Version Infromation
my $version = "    The Twelfth Step of CISDA (ChIP-Seq Data Analyzer), version 0.9.0, 2017-10-01.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  CISDA12.pl  -help' \n";
    exit 0;
}
