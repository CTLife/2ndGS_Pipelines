...
my $HELP = '
        ...
        Usage:
               perl  CISDA11A.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  CISDA11A.pl   -genome hg38   -in 7-finalBAM/1_Trim_BWAmem/callPeaks   -out 12A-MACS2/1_Trim_BWAmem    > CISDA11A.runLog
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  CISDA11A.pl  -help' \n";
    exit 0;
}
