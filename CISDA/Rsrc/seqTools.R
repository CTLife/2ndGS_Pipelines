...
{
outPath2 <- paste(outPath, "/4-mer", sep = "")
if( ! file.exists(outPath2) ) { dir.create(outPath2) }    

filenames <- dir(path=inputPath,   pattern="*.fastq$")
fq <- fastqq(file.path(inputPath, filenames), k=4)

file1 <- paste(outPath2, "/1-seqTools.txt", sep = "")
sink(file1)
print(filenames)
cat("\n\n\n\n\n")
print("All Files:")
...
file2 <- paste(outPath2, "/2-plotKmerCount.pdf", sep = "")
pdf(file2)
plotKmerCount(fq)
for (i in seq(1:num) ) {
    plotKmerCount(fq[i])
...
file3 <- paste(outPath2, "/3-plotNucFreq.pdf", sep = "")
pdf(file3)
for (i in seq(1:num) ) {
    plotNucFreq(fq, i)
}
...
file4 <- paste(outPath2, "/4-plotNucCount.pdf", sep = "")
pdf(file4)
plotNucCount(fq)
for (i in seq(1:num) ) {
    plotNucCount(fq[i])
...
file5 <- paste(outPath2, "/5-plotGCcontent.pdf", sep = "")
pdf(file5)  
plotGCcontent(fq) 
for (i in seq(1:num) ) {
    plotGCcontent(fq[i])
...
file6 <- paste(outPath2, "/6-plotPhredQuant.pdf", sep = "")
pdf(file6)  
plotMergedPhredQuant(fq, main = "Phred quantiles for all files")
for (i in seq(1:num) ) {
    plotPhredQuant(fq, i, paste("Phred quantiles for the file", i,  sep = "")  )
...
file7 <- paste(outPath2, "/7-Phred-distribution.pdf", sep = "")
pdf(file7)  
plotPhredDist(fq, main = "Phred distribution for all files")
for (i in seq(1:num) ) {
    plotPhredDist(fq[i], main = paste("Phred distribution for the file", i,  sep = "")  )
...
mtx <- cbDistMatrix(fq)
file8 <- paste(outPath2, "/8-DistMatrix.txt", sep = "")
write.table(mtx, file = file8, append = FALSE, quote = TRUE, sep = "\t",
                 eol = "\n", na = "NA", dec = ".", row.names = TRUE,
                 col.names = TRUE, qmethod = c("escape", "double"),
                 fileEncoding = "")
...
hc <- hclust(as.dist(mtx))
hcd <- as.dendrogram(hc, lty=1, lwd=2)
file9 <- paste(outPath2, "/9-hclust.pdf", sep = "")
pdf(file9)  
plot(hcd, horiz=TRUE,  las=1, edgePar=list(lwd=2, lty=1, col="blue"))
plot(hcd, horiz=FALSE, las=1, edgePar=list(lwd=2, lty=1, col="green4"))
dev.off()
file9 <- paste(outPath2, "/9-hclust.svg", sep = "")
svg(file9)  
plot(hcd, horiz=TRUE,  las=1, edgePar=list(lwd=2, lty=1, col="blue"))
dev.off()
}
...
{
outPath3 <- paste(outPath, "/2-mer", sep = "")
if( ! file.exists(outPath3) ) { dir.create(outPath3) }    

filenames <- dir(path=inputPath,   pattern="*.fastq$")
fq <- fastqq(file.path(inputPath, filenames), k=2)

file1 <- paste(outPath3, "/1-seqTools.txt", sep = "")
sink(file1)
print(filenames)
cat("\n\n\n\n\n")
print("All Files:")
...
file2 <- paste(outPath3, "/2-plotKmerCount.pdf", sep = "")
pdf(file2)
plotKmerCount(fq)
for (i in seq(1:num) ) {
    plotKmerCount(fq[i])
...
file3 <- paste(outPath3, "/3-plotNucFreq.pdf", sep = "")
pdf(file3)
for (i in seq(1:num) ) {
    plotNucFreq(fq, i)
}
...
file4 <- paste(outPath3, "/4-plotNucCount.pdf", sep = "")
pdf(file4)
plotNucCount(fq)
for (i in seq(1:num) ) {
    plotNucCount(fq[i])
...
file5 <- paste(outPath3, "/5-plotGCcontent.pdf", sep = "")
pdf(file5)  
plotGCcontent(fq) 
for (i in seq(1:num) ) {
    plotGCcontent(fq[i])
...
file6 <- paste(outPath3, "/6-plotPhredQuant.pdf", sep = "")
pdf(file6)  
plotMergedPhredQuant(fq, main = "Phred quantiles for all files")
for (i in seq(1:num) ) {
    plotPhredQuant(fq, i, paste("Phred quantiles for the file", i,  sep = "")  )
...
file7 <- paste(outPath3, "/7-Phred-distribution.pdf", sep = "")
pdf(file7)  
plotPhredDist(fq, main = "Phred distribution for all files")
for (i in seq(1:num) ) {
    plotPhredDist(fq[i], main = paste("Phred distribution for the file", i,  sep = "")  )
...
mtx <- cbDistMatrix(fq)
file8 <- paste(outPath3, "/8-DistMatrix.txt", sep = "")
write.table(mtx, file = file8, append = FALSE, quote = TRUE, sep = "\t",
                 eol = "\n", na = "NA", dec = ".", row.names = TRUE,
                 col.names = TRUE, qmethod = c("escape", "double"),
                 fileEncoding = "")
...
hc <- hclust(as.dist(mtx))
hcd <- as.dendrogram(hc, lty=1, lwd=2)
file9 <- paste(outPath3, "/9-hclust.pdf", sep = "")
pdf(file9)  
plot(hcd, horiz=TRUE,  las=1, edgePar=list(lwd=2, lty=1, col="blue"))
plot(hcd, horiz=FALSE, las=1, edgePar=list(lwd=2, lty=1, col="green4"))
dev.off()
file9 <- paste(outPath3, "/9-hclust.svg", sep = "")
svg(file9)  
plot(hcd, horiz=TRUE,  las=1, edgePar=list(lwd=2, lty=1, col="blue"))
dev.off()
}
